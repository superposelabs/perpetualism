    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          "Perpetualism is an avant-garde movement using emerging technology to create new forms of art."
        </p>

        <p className={styles.description}>
          Our focus is to foster artificial intelligence in creative endeavors while providing artists a global platform to create, monetize and distribute their creative works.
        </p>
        ...
        <div className={styles.grid}>
          <a href="/whitepaper" className={styles.card}>
            <h3>White Paper &rarr;</h3>
            <p>Read in-depth information about the Perpetualism platform including the economics.</p>
          </a>
